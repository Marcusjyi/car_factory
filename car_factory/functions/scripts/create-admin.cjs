/**
 * Create approved admin in Firestore `admins/{uid}` (mechanic_admin pattern).
 *
 *   cd car_factory/functions
 *   node scripts/create-admin.cjs <email> <password> [displayName] [employeeId] [role]
 */
